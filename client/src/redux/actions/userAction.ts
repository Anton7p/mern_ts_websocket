...
import {GET_OTHER_INFO, IGetOtherInfo, IProfileType} from "../types/profileType";
...
export const updateUser = (avatar: File, name: string, auth: IAuth) =>
    async (dispatch: Dispatch<IProfileType | IAlertType | IAuthType>) => {
...
export const getOtherInfo = (id: string) =>
    async (dispatch: Dispatch<IAlertType | IGetOtherInfo>) => {
